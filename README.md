...
I’m a **Frontend Developer** passionate about building clean, responsive, and user-friendly web applications. My focus is on crafting modern interfaces that deliver smooth user experiences, with a strong foundation in **JavaScript** and **React**.

- 💡 I enjoy turning design ideas into functional, interactive products and continuously learning new technologies to improve my craft.
- 🌱 Currently, I’m exploring **UI animations**, **React ecosystem tools**, and **performance optimization** to build more engaging applications.
- 🤝 Open to collaboration on projects where creativity meets problem-solving.
